...
from themis.modules.transforming.grapher import Grapher, EdgeType
...
def reconstruct_from_conf_pickle(
    config: Config
) -> nx.DiGraph:
...
def reconstruct_all_pickle(
    config: Config
) -> Generator[nx.DiGraph, Any, Any]:
...
def reconstruct_from_conf_gexf(
    config: Config
) -> nx.DiGraph:
...
def to_gexf(
    ...
    from themis.modules.transforming.gexf import write_gexf
